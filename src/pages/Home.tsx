        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              ...
              <a
                href="https://lin.ee/AK9Lwdb"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-transparent px-6 py-3 border border-gray-500 text-gray-300 rounded-md font-orbitron hover:bg-white/5 transition-colors"
              >
                聯絡我們
              </a>
            </div>
          ...
          >
            {[
              ...
              <div key={index} className="glass-panel p-6 text-center">
                <div className="text-3xl font-orbitron font-bold neon-text mb-2">
                  {stat.value}
                </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-orbitron font-bold mb-4">
              我們的<span className="neon-text">專業服務</span>
            </h2>
            <p className="text-gray-300 max-w-2xl mx-auto">
              打造全方位的數位解決方案，從系統開發到智能機器人，一站式滿足您的需求
            </p>
          </div>
            ...
            {[
              {
                ...
                title: "系統開發",
                description:
                  "從需求分析到系統實現，打造高效、安全、穩定的企業級應用系統。",
              },
              {
                icon: <MessageSquare size={24} />,
                title: "對話機器人",
                description:
                  "基於NLP技術的智能對話系統，提升客服效率和顧客體驗。",
              },
              {
                icon: <Database size={24} />,
                title: "CMS管理",
                description:
                  "直覺化的內容管理系統，讓您輕鬆管理網站內容，無需技術背景。",
              },
              {
                icon: <Brain size={24} />,
                title: "客製化系統",
                description:
                  "根據企業獨特需求，量身打造專屬系統，解決業務痛點。",
              },
              {
                icon: <Layout size={24} />,
                title: "形象網站",
                description:
                  "融合藝術設計與技術，打造獨特的品牌數位形象，吸引目標客群。",
              },
            ].map((service, index) => (
              <div
                key={index}
          ...
          >
            ...
            <div className="relative z-10">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-orbitron font-bold mb-4">
                  為何選擇<span className="neon-text">我們</span>
                </h2>
                <p className="text-gray-300 max-w-2xl mx-auto">
                  我們結合頂尖技術與豐富經驗，為客戶創造最大價值
                </p>
              </div>
                ...
                {[
                  {
                    title: "技術領先",
                    description:
                      "採用最新AI與雲端技術，確保解決方案具有前瞻性和競爭力。",
                  },
                  {
                    title: "專業團隊",
                    description:
                      "擁有豐富經驗的專業團隊，每位成員都是各自領域的專家。",
                  },
                  {
                    title: "客戶為本",
                    description:
                      "深入理解客戶需求，提供超越期待的服務與解決方案。",
                  },
                  {
                    title: "敏捷開發",
                    description:
                      "採用敏捷方法論，快速迭代、持續交付，縮短上市時間。",
                  },
                  {
                    title: "全面支援",
                    description:
                      "提供24/7技術支援，確保系統穩定運行，快速解決問題。",
                  },
                  {
                    title: "持續創新",
                  ...
                  <div
                    ...
                    style={{ animationDelay: `${index * 0.1}s` }}
                  >
                    <h3 className="text-lg font-orbitron font-semibold mb-3 neon-text">
                      {item.title}
                    </h3>
