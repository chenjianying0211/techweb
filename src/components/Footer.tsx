        ...
        <div className="container mx-auto py-12 px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-300 mb-6">
              IFWIN
              奕福穎科技公司專注於提供尖端AI技術解決方案，幫助企業實現數位轉型並釋放數據的全部潛力。
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  to="/services"
                  className="text-gray-300 hover:text-neonTurquoise transition-colors"
                >
                  系統開發
                </Link>
              </li>
        ...
        <div className="border-t border-gray-700/50">
          <div className="container mx-auto px-4 py-6 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © 2025 IFWIN 奕福穎科技公司. 版權所有.
            </p>
            <div className="flex gap-6">
              <Link
                to="#"
                className="text-gray-400 text-sm hover:text-neonTurquoise transition-colors"
              >
                隱私政策
              </Link>
              <Link
